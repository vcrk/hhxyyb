    ...
    <div>
        <div class="yb-bac">
            ...
            <el-row style="margin-top:5px;border-radius:6px;width:95%;margin-left:2.5%;background:#efefef;">
                <div v-for="a in category" :key="a" style="width:20%;float:left;">
...
<style>
    *{
    ...
    .yb-bac{
        padding-bottom: 5px;
        padding-top: 5px;
        background: -webkit-linear-gradient(top,rgb(47,169,204) 0%,rgb(216, 240, 247) 100%);
    }
    .yb-input{
        width: 50%!important;
    }
    ...
    width: 25%!important;
    color: #fff;
    background-color: #22ebf1!important;
