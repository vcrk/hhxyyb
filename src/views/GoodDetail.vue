    ...
    <div style="">
        <div class="gd-top">
            <el-row>
                ...
                <strong><span style="float:left;margin-left:3%">ID：{{username}}<br></span></strong>
                ...
                <br>
                <br>
                <span style="float:left;margin-left:6%;font-size:75%;line-height:0%;color:gray">发布于：怀化学院{{location}}</span>  
        ...
        <div style="float:left;margin-left:3%;margin-right:3%">
            ...
            <div style="">
                ...
                <div style="margin-bottom:30px">
                    ...
                    <!-- <el-button > -->
                    <span v-if="freeze === '0'" type="text" @click="open2" style="background-color:red;color:#fff;font-size:120%;float:right;padding-left:8px;padding-right:8px;border-radius: 3px;">
                        我想要
                    </span>
                    <span v-else type="text"  style="background-color:red;color:#fff;font-size:120%;float:right;padding-left:8px;padding-right:8px;border-radius: 3px;">
                        已租出
                    </span>
                    <!-- </el-button> -->
                    <br><br><br><br>
